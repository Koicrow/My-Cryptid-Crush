...
label greg3_invite3:
    ...
    g "{size=+7}{font=Iceland-Regular.ttf}{i}Ur gonna have to try harder than that{/i}{/font}{/size}"
...
label greg3_carry2:
    ...
    "Greg leans over, then picks me up with one arm under my knees and the other under my back. It's actually pretty comfortable. Unlike last time, he smells strongly like cologne. He didn't put that on just for me, did he?"
...
label greg3_carry4:
    ...
    "He lifts off with a powerful jump. I yelp as my feet leave the ground, then we're soaring up and up into an endless sky."
    ...
    "It's surprisingly spacious, complete with floor pillows and a collapsible drawing desk. One corner has a minifridge and a bunsen burner, their cords disappearing under the wall. In another corner, clothes hang from a makeshift rack. Fairy lights droop down from the ceiling. The whole thing looks thrown-together, but comfy."
    ...
    g "This is the building that I janitor...ize. The place where I'm a janitor. The location is great, and the view is killer. Best part about it? No rent."
...
label greg3_pad4:
    ...
    "Greg waves Yang away. Meanwhile, Yin perches happily on a little cat bed."
    
    yi "Oh, home sweet bed! It's been too long!"
...
label greg3_passerby3:
    ...
    "I look frantically around, then turn off the flashlight and dash down the street. I duck into an alleyway where hopefully no one will see me. My heart is beating like crazy. Shouldn't Greg have briefed me on this?!"
    ...
    p "Um... I didn't think of that. My bad."
...
label greg3_cigs1:
    ...
    "He takes one himself and lights us both up. I take a deep draft."
