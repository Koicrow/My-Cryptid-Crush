...
label greg2_great3:
    ...
    "I shove my phone back into my pocket and mount my bike, maybe a little more excited than I should be. I start cycling toward the inner city. It's been a hot second since I've been to the mall. I wonder if that comic book store is still there?"
    ...
    p "Waldo's? Is that by, uh, Good Buy?"
...
label greg2_socks2:
    ...
    "He continues down the corridor. I laugh, replace the gay socks, and hurry afer him."
...
label greg2_socks6:
    ...
    p "Ooh, I see. Where do you work, anyway? Since you're a cryptid, and all?"
...
label greg2_spree4:
    ...
    p "Heh, I wasn't loving it anyway. Let's just get your socks."
...
label greg2_spree7:
    ...
    p "Doesn't really suit you, to be honest. You look like a goth Harry Blotter fan."
...
label greg2_genre4:
    ...
    ya "You shouldn't steal it {i}or{/i} pirate it. You wouldn't download a car, would you?"
    
    "You know, I know you're not really an angel and a demon, but you fulfill the roles very well."
...
label greg2_steal2:
    ...
    ya "Tsk, tsk. You should have listened to me."
...
label greg2_drink4:
    ...
    p "Wait, are you telling me you're avoiding discovery because people are too polite to ask?!"
...
label greg2_noodles4:
    ...
    "Greg winks and gets up to throw his trash away. With a huff, I collect the rest of my stuff and stand up as well."
